...
public class DaoTest {
	...
	public static void setUpJndi() throws NamingException {
		...
		p.setUrl("jdbc:mysql://localhost/PhotoAlbum");
	...
	public void testCreateAndUpdateFileShareInformation() {
		...
		fsil = this.fileShareInformationService.getFileShares(file.getId());
	...
	public void testGetUserSharingWith() {
		...
		List<User> list = this.userService.getUsersSharingWith(user.getId());
		List<User> list2 = this.userService.getUsersSharingWith(user2.getId());
		List<User> list3 = this.userService.getUsersSharingWith(user3.getId());
		List<User> list4 = this.userService.getUsersSharingWith(user4.getId());
	...
	public void testGetAlbumSharedWith() {
		...
		List<Album> list = this.albumService.getAlbumsSharedWith(user2.getId(),
				user.getEmail());
		List<Album> list2 = this.albumService.getAlbumsSharedWith(user.getId(),
				user2.getEmail());
	...
	public void testGetAlbumFilesOwn() {
		...
		List<File> filesOwn = this.fileService.getAlbumFilesOwn(album.getId());
	...
	public void testGetAlbumFilesSharedPaging() {
		...
		List<File> filesShared = this.fileService.getAlbumFilesSharedPaging(
				album.getId(), user2.getId(), 0, 1);
		List<File> filesShared2 = this.fileService.getAlbumFilesSharedPaging(
				album.getId(), user2.getId(), 1, 1);
	...
	public void getAlbumFilesPublicPaging() {
		...
		List<File> filesPublic = this.fileService.getAlbumFilesPublicPaging(
				album.getId(), user.getId(), 0, 2);
		List<File> filesPublic2 = this.fileService.getAlbumFilesPublicPaging(
				album.getId(), user2.getId(), 2, 1);
	...
	public void TestGetAlbumsByTag() {
		...
		List<Album> albums = this.albumService.getAlbumsByTag(user.getId(),
				"tag");
	...
	public void TestGetFilesByTag() {
		...
		this.fileTagService.create(tag3);
		List<File> files = this.fileService.getFilesByTag(user.getId(), "tag");
	...
	public void TestGetFilesByTagPaging() {
		...
		List<File> files = this.fileService.getFilesByTagPaging(user.getId(),
				"tag", 1, 2);
		List<File> files2 = this.fileService.getFilesByTagPaging(user.getId(),
				"tag", 0, 3);
	...
	public void testGetVotedListAlbum() {
		...
		List<Voted> list = this.votedService.getVoted(likeAndDislikeIdList2,
				user.getId());
	...
	public void testGetFiles() throws InterruptedException {
		...
		this.albumService.create(album3);
		Thread.sleep(10);
		Album album4 = new Album(null, "FourthAlbum", user, null, null,
				PrivacyLevel.PUBLIC);
		this.albumService.create(album4);
		Thread.sleep(10);
		Album album5 = new Album(null, "FifthAlbum", user, null, null,
				PrivacyLevel.PRIVATE);
		...
		this.fileService.changePrivacyLevel(file1, PrivacyLevel.PUBLIC);
		this.fileService.changePrivacyLevel(file5, PrivacyLevel.PUBLIC);
		this.fileService.changePrivacyLevel(file10, PrivacyLevel.PUBLIC);
		this.fileService.changePrivacyLevel(file8, PrivacyLevel.PUBLIC);
		this.fileService.changePrivacyLevel(file9, PrivacyLevel.PRIVATE);

		this.likeAndDislikeService.voteLike(file1.getLikeAndDislike(), user);
		this.likeAndDislikeService.voteLike(file2.getLikeAndDislike(), user);
		this.likeAndDislikeService.voteLike(file1.getLikeAndDislike(), user2);
		this.likeAndDislikeService
				.voteDislike(file4.getLikeAndDislike(), user2);
		this.likeAndDislikeService.voteDislike(file4.getLikeAndDislike(), user);
		this.likeAndDislikeService
				.voteDislike(file6.getLikeAndDislike(), user2);
		this.likeAndDislikeService
				.voteDislike(file9.getLikeAndDislike(), user2);
		this.likeAndDislikeService
				.voteDislike(file4.getLikeAndDislike(), user3);
		this.likeAndDislikeService
				.voteDislike(file3.getLikeAndDislike(), user3);
		this.likeAndDislikeService
				.voteDislike(file6.getLikeAndDislike(), user3);
		this.likeAndDislikeService.voteLike(file10.getLikeAndDislike(), user3);

		Comment comment = new Comment(file1.getLikeAndDislike(), user,
				"Prueba comment", null, file1);
		this.commentService.create(user, file1, comment.getText());

		Comment comment2 = new Comment(album5.getLikeAndDislike(), user,
				"Prueba 2", null, file4);
		...
		List<File> listFLkN = fileService.getFiles("File", true, false, false,
				"like", file1.getDate(), file10.getDate(), 0, 10);
		List<File> listFDkN = fileService.getFiles("File", true, false, false,
				"dislike", file1.getDate(), file10.getDate(), 0, 10);
		List<File> listFFkN = fileService.getFiles("File", true, false, false,
				"date", file5.getDate(), file10.getDate(), 2, 10);
		List<File> listFFkNV = fileService.getFiles("manzana", true, false,
				false, "date", file1.getDate(), file10.getDate(), 0, 10);
		List<File> listFFkNPag = fileService.getFiles("File", true, false,
				false, "date", file1.getDate(), file10.getDate(), 0, 5);

		List<File> listFLkC = fileService.getFiles("Pr", false, true, false,
				"like", file2.getDate(), file10.getDate(), 0, 10);
		List<File> listFDkC = fileService.getFiles("Pr", false, true, false,
				"dislike", file1.getDate(), file10.getDate(), 0, 10);
		List<File> listFFkC = fileService.getFiles("Pr", false, true, false,
				"date", file3.getDate(), file10.getDate(), 0, 10);
		List<File> listFFkCV = fileService.getFiles("manzana", false, true,
				false, "dislike", file3.getDate(), file10.getDate(), 0, 10);

		List<File> listFLkT = fileService.getFiles("Prue", false, false, true,
				"like", file1.getDate(), file10.getDate(), 0, 10);
		List<File> listFDkT = fileService.getFiles("Prue", false, false, true,
				"dislike", file1.getDate(), file10.getDate(), 0, 10);
		List<File> listFFkT = fileService.getFiles("Prue", false, false, true,
				"date", file1.getDate(), file10.getDate(), 1, 3);
		List<File> listFFkV = fileService.getFiles("manzana", false, false,
				true, "date", file1.getDate(), file10.getDate(), 0, 10);
		...
		List<File> listFLof = fileService.getFiles("like", file1.getDate(),
				file10.getDate(), 0, 10);
		List<File> listFDof = fileService.getFiles("dislike", file1.getDate(),
				file10.getDate(), 0, 5);
		List<File> listFFof = fileService.getFiles("date", file1.getDate(),
				file10.getDate(), 0, 5);

		List<File> listFLokN = fileService.getFiles("File", true, false, false,
				"like", 0, 10);
		List<File> listFDokN = fileService.getFiles("File", true, false, false,
				"dislike", 0, 10);
		List<File> listFFokN = fileService.getFiles("File", true, false, false,
				"date", 0, 10);

		List<File> listFLokC = fileService.getFiles("Pru", false, true, false,
				"like", 0, 10);
		List<File> listFDokC = fileService.getFiles("Pru", false, true, false,
				"dislike", 0, 10);
		List<File> listFFokC = fileService.getFiles("Pru", false, true, false,
				"date", 0, 10);

		List<File> listFLokT = fileService.getFiles("Pru", false, false, true,
				"like", 0, 5);
		List<File> listFDokT = fileService.getFiles("Pru", false, false, true,
				"dislike", 0, 5);
		List<File> listFFokT = fileService.getFiles("Pru", false, false, true,
				"date", 0, 1);
		List<File> listFFokTPag = fileService.getFiles("Pru", false, false,
				true, "date", 1, 1);
	...
	public void test_GetAlbums() throws InterruptedException {
		...
		this.likeAndDislikeService.voteLike(album4.getLikeAndDislike(), user2);
		this.likeAndDislikeService.voteLike(album4.getLikeAndDislike(), user);
		this.likeAndDislikeService.voteLike(album2.getLikeAndDislike(), user2);
		this.likeAndDislikeService.voteDislike(album3.getLikeAndDislike(),
				user3);
		this.likeAndDislikeService.voteDislike(album3.getLikeAndDislike(),
				user2);
		this.likeAndDislikeService
				.voteDislike(album5.getLikeAndDislike(), user);

		Comment commentA = new Comment(album3.getLikeAndDislike(), user,
				"Prueba comment", album3, null);
		this.commentService.create(user, album3, commentA.getText());
		Thread.sleep(10);

		Comment commentA2 = new Comment(album4.getLikeAndDislike(), user,
				"Prueba 2", album4, null);
		...
		List<Album> listALkN = albumService.getAlbums("Album", true, false,
				false, "like", album.getDate(), album5.getDate(), 0, 10);
		List<Album> listALkN2 = albumService.getAlbums("Album", true, false,
				false, "like", album.getDate(), album5.getDate(), 1, 10);
		List<Album> listADkN = albumService.getAlbums("Album", true, false,
				false, "dislike", album.getDate(), album5.getDate(), 0, 10);
		List<Album> listAFkN = albumService.getAlbums("Album", true, false,
				false, "date", album.getDate(), album5.getDate(), 0, 10);
		List<Album> listAFkN2 = albumService.getAlbums("Album", true, false,
				false, "date", album.getDate(), album5.getDate(), 2, 1);
		List<Album> listAFkNV = albumService.getAlbums("manzana", true, false,
				false, "date", album.getDate(), album5.getDate(), 2, 1);

		List<Album> listALkC = albumService.getAlbums("Pru", false, true,
				false, "like", album.getDate(), album5.getDate(), 0, 10);
		List<Album> listADkC = albumService.getAlbums("Pru", false, true,
				false, "dislike", album.getDate(), album5.getDate(), 0, 10);
		List<Album> listAFkC = albumService.getAlbums("Pru", false, true,
				false, "date", album.getDate(), album5.getDate(), 1, 1);
		List<Album> listADkCV = albumService.getAlbums("manzana", false, true,
				false, "dislike", album.getDate(), album5.getDate(), 0, 10);

		List<Album> listALkT = albumService.getAlbums("Pru", false, false,
				true, "like", album4.getDate(), album5.getDate(), 0, 10);
		List<Album> listADkT = albumService.getAlbums("Pru", false, false,
				true, "dislike", album.getDate(), album5.getDate(), 0, 10);
		List<Album> listAFkT = albumService.getAlbums("Pru", false, false,
				true, "date", album.getDate(), album5.getDate(), 1, 10);
		List<Album> listAFkTV = albumService.getAlbums("manzana", false, false,
				true, "date", album.getDate(), album5.getDate(), 1, 10);
		...
		List<Album> listALof = albumService.getAlbums("like", album.getDate(),
				album5.getDate(), 0, 10);
		List<Album> listADof = albumService.getAlbums("dislike",
				album2.getDate(), album5.getDate(), 1, 2);
		List<Album> listAFof = albumService.getAlbums("date", album.getDate(),
				album5.getDate(), 1, 3);
		List<Album> listALofV = albumService.getAlbums("like", album.getDate(),
				album5.getDate(), 6, 10);

		List<Album> listALokN = albumService.getAlbums("Album", true, false,
				false, "like", 0, 10);
		List<Album> listADokN = albumService.getAlbums("Album", true, false,
				false, "dislike", 1, 10);
		List<Album> listAFokN = albumService.getAlbums("Album", true, false,
				false, "date", 1, 2);
		List<Album> listAFokVN = albumService.getAlbums("manzana", true, false,
				false, "date", 1, 2);

		List<Album> listALokC = albumService.getAlbums("Pru", false, true,
				false, "like", 0, 10);
		List<Album> listADokC = albumService.getAlbums("Pru", false, true,
				false, "dislike", 1, 3);
		List<Album> listAFokC = albumService.getAlbums("Pru", false, true,
				false, "date", 0, 3);
		List<Album> listAFokCV = albumService.getAlbums("manzana", false, true,
				false, "date", 0, 3);

		List<Album> listALokT = albumService.getAlbums("Prue", false, false,
				true, "like", 0, 3);
		List<Album> listADokT = albumService.getAlbums("Prue", false, false,
				true, "dislike", 1, 1);
		List<Album> listAFokT = albumService.getAlbums("Prue", false, false,
				true, "date", 0, 5);
		List<Album> listAFokTV = albumService.getAlbums("manzana", false,
				false, true, "date", 0, 5);
