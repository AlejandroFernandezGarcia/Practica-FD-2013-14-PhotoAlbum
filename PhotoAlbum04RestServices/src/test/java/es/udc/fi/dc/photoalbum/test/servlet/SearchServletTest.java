...
public class SearchServletTest {
	...
	public void startServer() throws IOException {
		ConfigurableApplicationContext cac = new ClassPathXmlApplicationContext("classpath:applicationContextForTest.xml");
	...
	public void testTypeNull() throws IOException {
		...
		WebResource service = client.resource(getBaseURI() + "PhotoAlbum04/");
	...
	public void testNonExistingType() throws IOException {
		...
		String response = service.path("search")
				...
				.queryParam("dateFirst", "10/01/2012").get(String.class);
		assertFalse(response.contains("file-dtos"));
		assertFalse(response.contains("album-dtos"));
	...
	public void testIncorrectDate() throws IOException {
		Client client = Client.create(new DefaultClientConfig());
		WebResource service = client.resource(getBaseURI() + "PhotoAlbum04/");
		String response = service.path("search").queryParam("type", "file")
	...
	public void testIncorrectDate3() throws IOException {
		...
		String response = service.path("search").queryParam("type", "file")
				.queryParam("dateFirst", "01/11/2012")
				.queryParam("dateEnd", "02/11/2011").get(String.class);
		assertFalse(response.contains("file-dtos"));
		assertFalse(response.contains("album-dtos"));
	...
	@Test
	public void testCorrectFileWithFilterDateAndFindBy() throws IOException {
		Client client = Client.create(new DefaultClientConfig());
		WebResource service = client.resource(getBaseURI() + "PhotoAlbum04/");
		String response = service.path("search").queryParam("type", "file")
				.queryParam("findBy", "name").queryParam("keywords", "evento")
				.queryParam("orderBy", "date")
				.queryParam("dateFirst", "01/11/2012")
				.queryParam("dateEnd", "02/11/2012").get(String.class);
	...
	@Test
	public void testCorrectFileWithoutFilterDateWithFindBy() throws IOException {
		Client client = Client.create(new DefaultClientConfig());
		WebResource service = client.resource(getBaseURI() + "PhotoAlbum04/");
		String response = service.path("search").queryParam("type", "file")
				.queryParam("findBy", "name").queryParam("keywords", "evento")
	...
	@Test
	public void testCorrectFileWithFilterDateWithoutFindBy() throws IOException {
		Client client = Client.create(new DefaultClientConfig());
		WebResource service = client.resource(getBaseURI() + "PhotoAlbum04/");
		String response = service.path("search").queryParam("type", "file")
				.queryParam("orderBy", "date")
	...
	@Test
	public void testCorrectAlbumWithFilterDateAndFindBy() throws IOException {
		Client client = Client.create(new DefaultClientConfig());
		WebResource service = client.resource(getBaseURI() + "PhotoAlbum04/");
		String response = service.path("search").queryParam("type", "album")
				.queryParam("findBy", "name").queryParam("keywords", "evento")
				.queryParam("orderBy", "date")
				.queryParam("dateFirst", "01/11/2012")
				.queryParam("dateEnd", "02/11/2012").get(String.class);
		...
		assertTrue("Assert album-dtos failed",
	...
	/* Type = all */
	@Test
	public void testCorrectAllWithFilterDateAndFindBy() throws IOException {
		Client client = Client.create(new DefaultClientConfig());
		WebResource service = client.resource(getBaseURI() + "PhotoAlbum04/");
		String response = service.path("search").queryParam("type", "all")
				.queryParam("findBy", "name").queryParam("keywords", "evento")
				.queryParam("orderBy", "date")
				.queryParam("dateFirst", "01/11/2012")
				.queryParam("dateEnd", "02/11/2012").get(String.class);
	...
	@Test
	public void testCorrectAllWithoutFilterDateWithFindBy() throws IOException {
		Client client = Client.create(new DefaultClientConfig());
		WebResource service = client.resource(getBaseURI() + "PhotoAlbum04/");
		String response = service.path("search").queryParam("type", "all")
				.queryParam("findBy", "name").queryParam("keywords", "evento")
	...
	@Test
	public void testCorrectAllWithFilterDateWithoutFindBy() throws IOException {
		Client client = Client.create(new DefaultClientConfig());
		WebResource service = client.resource(getBaseURI() + "PhotoAlbum04/");
		String response = service.path("search").queryParam("type", "all")
				.queryParam("orderBy", "date")
	...
	public void testHottestPics() throws IOException {
		...
		assertTrue(response.contains("File: Search with only orderBy"));
	...
	public void testAlbumDtoJax() {
		...
		assertEquals(adj.toString(), "AlbumDtoJax [id=" + 1 + ", name="
				+ "Test 1" + "]");
	}
	...
	public void testFileDtoJax() {
		...
		assertEquals(fdj.toString(), "FileDtoJax [id=" + 1 + ", name="
				+ "Test file" + ", fileSmall=" + Arrays.toString(new byte[1])
				+ "]");
	}
	...
	public void testValidateFindByAndKeywords() {
		...
		assertTrue(ValidateParameters.validateFindByAndKeywords(list2,
				"Evento1"));
		assertTrue(ValidateParameters.validateFindByAndKeywords(list3,
				"Evento2"));

		assertFalse(ValidateParameters.validateFindByAndKeywords(list4,
				"Evento"));
		assertFalse(ValidateParameters.validateFindByAndKeywords(list5,
				"Evento"));
		assertFalse(ValidateParameters.validateFindByAndKeywords(list3, null));
		assertFalse(ValidateParameters.validateFindByAndKeywords(list6,
				"Evento"));
	}
